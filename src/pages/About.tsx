    ...
    <Scroll>
      <div id="about" className="about">
        ...
        <h2 className="content-text">
          ...
          sit amet consectetur adipisicing elit. Dolorem, explicabo. Soluta
          autem vero, aliquam, iste odit nostrum quae nulla, nisi ad ipsa natus
          hic cupiditate sit adipisci neque voluptatem magnam?
        </h2>
      </div>
    </Scroll>
  );
